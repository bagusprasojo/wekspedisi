...
closing_list_view, closing_create_view, _, closing_delete_view = build_crud_views(
    CrudConfig(
        model=ClosingPeriod,
...
urlpatterns = [
    ...
    path('jurnal/<uuid:uuid>/', views.journal_detail, name='accounting_jurnal_detail'),
