...
CONFIGS = {
    'transaksi-kas': CrudConfig(model=CashTransaction, form_class=CashTransactionForm, title='Transaksi Kas', list_display=['no_bukti', 'tanggal', 'akun_transaksi', 'keterangan', 'bank', 'armada', 'nominal_keluar', 'nominal_masuk', 'created_by'], list_labels={'no_bukti': 'No Bukti', 'akun_transaksi': 'Akun Biaya/Pendapatan', 'nominal_keluar': 'Pengeluaran', 'nominal_masuk': 'Penerimaan', 'created_by': 'Pc'}, search_fields=['no_bukti', 'keterangan', 'akun_transaksi__kode', 'akun_transaksi__nama', 'bank__no_rekening', 'armada__nopol'], success_url_name='finance_transaksi_kas_list', detail_url_name='finance_transaksi_kas_detail'),
    'transaksi-bank': CrudConfig(model=BankTransaction, form_class=BankTransactionForm, title='Transaksi Bank', list_display=['no_bukti', 'tanggal', 'bank_utama.no_rekening', 'bank_utama.nama_bank', 'jenis_transaksi.nama', 'debet', 'kredit', 'biaya_adm_bank', 'uraian', 'created_by'], list_labels={'no_bukti': 'No Bukti', 'bank_utama.no_rekening': 'No Rek', 'bank_utama.nama_bank': 'Nama Bank', 'jenis_transaksi.nama': 'Transaksi', 'biaya_adm_bank': 'Adm. Bank', 'created_by': 'User'}, search_fields=['no_bukti', 'uraian', 'bank_utama__no_rekening', 'bank_utama__nama_bank', 'bank_utama__atas_nama', 'jenis_transaksi__kode', 'jenis_transaksi__nama'], success_url_name='finance_transaksi_bank_list', detail_url_name='finance_transaksi_bank_detail', hide_list_edit=True),
    'pembelian-bbm': CrudConfig(model=FuelPurchase, form_class=FuelPurchaseForm, title='Pembelian BBM', list_display=['no_bukti', 'tanggal', 'armada', 'km_terakhir', 'km_sekarang', 'nominal_bbm'], search_fields=['no_bukti', 'keterangan'], success_url_name='finance_pembelian_bbm_list'),
