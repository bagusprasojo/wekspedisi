...
from finance.forms import BankTransactionForm, CashTransactionForm, EmployeeCashAdvanceForm, EmployeeCashAdvancePaymentForm, FuelPurchaseForm, LoanDebtForm, LoanDebtPaymentForm, LoanReceivableForm, LoanReceivablePaymentForm
...
CONFIGS = {
    ...
    'hutang-pinjaman': CrudConfig(model=LoanDebt, form_class=LoanDebtForm, title='Hutang Pinjaman', list_display=['no_register', 'tanggal', 'perkiraan_hutang', 'pemberi_pinjaman.nama', 'sumber_dana', 'nominal', 'pelunasan', 'saldo', 'status_lunas', 'keterangan', 'created_by'], list_labels={'no_register': 'No Register', 'perkiraan_hutang': 'Akun Hutang', 'pemberi_pinjaman.nama': 'Pemberi Pinjaman', 'sumber_dana': 'Penerima Uang', 'status_lunas': 'Status Lunas', 'created_by': 'Pc'}, search_fields=['no_register', 'status_lunas', 'pemberi_pinjaman__nama', 'sumber_dana', 'keterangan', 'perkiraan_hutang__kode', 'perkiraan_hutang__nama'], success_url_name='finance_hutang_pinjaman_list', detail_url_name='finance_hutang_pinjaman_detail', hide_list_edit=True),
    'pembayaran-hutang': CrudConfig(model=LoanDebtPayment, form_class=LoanDebtPaymentForm, title='Pembayaran Hutang', list_display=['no_register', 'hutang_pinjaman.no_register', 'hutang_pinjaman.pemberi_pinjaman.nama', 'tanggal', 'sumber_dana', 'hutang', 'nominal', 'keterangan', 'created_by'], list_labels={'no_register': 'No Register', 'hutang_pinjaman.no_register': 'No Hutang', 'hutang_pinjaman.pemberi_pinjaman.nama': 'Pemberi Pinjaman', 'sumber_dana': 'Sumber Uang', 'hutang': 'Hutang', 'nominal': 'Pembayaran', 'created_by': 'Pc'}, search_fields=['no_register', 'hutang_pinjaman__pemberi_pinjaman__nama', 'hutang_pinjaman__sumber_dana', 'hutang_pinjaman__keterangan', 'hutang_pinjaman__no_register'], success_url_name='finance_pembayaran_hutang_list', detail_url_name='finance_pembayaran_hutang_detail', hide_list_edit=True),
    'piutang-pinjaman': CrudConfig(model=LoanReceivable, form_class=LoanReceivableForm, title='Piutang Pinjaman', list_display=['no_register', 'tanggal', 'perkiraan_piutang', 'penerima_pinjaman.nama', 'sumber_dana', 'nominal', 'pelunasan', 'saldo', 'status_lunas', 'keterangan', 'created_by'], list_labels={'no_register': 'No Register', 'perkiraan_piutang': 'Akun Piutang', 'penerima_pinjaman.nama': 'Penerima Pinjaman', 'sumber_dana': 'Sumber Uang', 'status_lunas': 'Status Lunas', 'created_by': 'Pc'}, search_fields=['no_register', 'status_lunas', 'penerima_pinjaman__nama', 'sumber_dana', 'keterangan', 'perkiraan_piutang__kode', 'perkiraan_piutang__nama'], success_url_name='finance_piutang_pinjaman_list', detail_url_name='finance_piutang_pinjaman_detail', hide_list_edit=True),
    'pembayaran-piutang': CrudConfig(model=LoanReceivablePayment, form_class=LoanReceivablePaymentForm, title='Pembayaran Piutang', list_display=['no_register', 'piutang_pinjaman.no_register', 'piutang_pinjaman.penerima_pinjaman.nama', 'tanggal', 'sumber_dana', 'nominal', 'keterangan', 'created_by'], list_labels={'no_register': 'No Register', 'piutang_pinjaman.no_register': 'No Piutang', 'piutang_pinjaman.penerima_pinjaman.nama': 'Penerima Pinjaman', 'sumber_dana': 'Penerima Uang', 'nominal': 'Pembayaran', 'created_by': 'Pc'}, search_fields=['no_register', 'piutang_pinjaman__penerima_pinjaman__nama', 'piutang_pinjaman__sumber_dana', 'piutang_pinjaman__keterangan', 'piutang_pinjaman__no_register'], success_url_name='finance_pembayaran_piutang_list', detail_url_name='finance_pembayaran_piutang_detail', hide_list_edit=True),
}
...
urlpatterns = [
    ...
    path('hutang-pinjaman/lookup/', views.loan_debt_lookup, name='finance_hutang_pinjaman_lookup'),
    path('hutang-pinjaman/<uuid:uuid>/', views.loan_debt_detail, name='finance_hutang_pinjaman_detail'),
    path('pembayaran-hutang/<uuid:uuid>/', views.loan_debt_payment_detail, name='finance_pembayaran_hutang_detail'),
    path('piutang-pinjaman/lookup/', views.loan_receivable_lookup, name='finance_piutang_pinjaman_lookup'),
    path('piutang-pinjaman/<uuid:uuid>/', views.loan_receivable_detail, name='finance_piutang_pinjaman_detail'),
    path('pembayaran-piutang/<uuid:uuid>/', views.loan_receivable_payment_detail, name='finance_pembayaran_piutang_detail'),
]
